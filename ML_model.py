...
# evaluator_precision = MulticlassClassificationEvaluator(labelCol="HeartDiseaseStatus", predictionCol="prediction", metricName="weightedPrecision")
# precision = evaluator_precision.evaluate(predictions)

# evaluator_f1 = MulticlassClassificationEvaluator(labelCol="HeartDiseaseStatus", predictionCol="prediction", metricName="f1")
